...
class Aptaxi_Walker_Nav_Menu extends Walker_Nav_Menu {
	/*
	...
	// function start_lvl( &$output, $depth = 0, $args = NULL ) {
		 ...
		 */ 
		$output .= '<ul id="aptaxi_main_menu" class="aptaxi-main-menu aptaxi-navbar-content">';
	}
	/**
	 * @see Walker::start_el()
	 * @since 3.0.0
	...
	function start_el( &$output, $item, $depth = 0, $args = NULL, $id = 0 ) {
        ...
        $attributes .= ! empty ($item->post_icon)   ? '<img src="' . esc_attr($item->post_icon)   . '"' : '';
 
		// ссылка и околоссылочный текст
        $item_output = $args->before;
        $item_output = $args->post_icon;
