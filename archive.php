                ...
                <?php AptaxiBreadcrumbs(' / '); ?>
                    <div class="aptaxi-btn-archive-content-wrapper">
                        ...
                        <a href="<?php echo get_category_link( 12 ); ?>" data-name="<?php echo get_cat_name( 12 ); ?>"
                         class="aptaxi-category-btn btn-cat-12 <?php if ($current_url == 'http://taxi.planer-studio.ru/?cat=12' OR $current_url == 'http://taxi.planer-studio.ru/?cat=13') {
                          echo ' aptaxi-cat-active';} ?>">
                            <?php echo get_cat_name( 12 ); ?>
                        </a>
                        <a href="<?php echo get_category_link( 14 ); ?>" data-name="<?php echo get_cat_name( 14 ); ?>" 
                        class="aptaxi-category-btn btn-cat-14 <?php if ($current_url == 'http://taxi.planer-studio.ru/?cat=14' OR $current_url == 'http://taxi.planer-studio.ru/?cat=15') {
                            echo 'aptaxi-cat-active'; 
                        } ?>">
                        ...
                        <div class="aptaxi-loop-categories aptaxi-categories-content aptaxi-layout-grid">
                            <?php
                                    while (have_posts()): the_post();
                                        require_once TEMPLATEPATH . '/templates/category/post.php';
